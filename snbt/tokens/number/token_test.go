...
func TestNumber(t *testing.T) {
	...
	readNext()
	assertVal(float64(-56.78), 'D')
	readNext()
	assertVal(float64(3.2), 'D')
	readNext()
	assertVal(float64(-3.0), 'D')
	readNext()
	assertVal(float64(-0.2), 'D')
	readNext()
	assertVal(float64(-234.0), 'D')
	readNext()
	assertVal(float64(-0.456), 'D')
	readNext()
	assertVal(float64(1.23), 'D')
	readNext()
	assertVal(float64(-4.56), 'D')
	readNext()
	assertVal(float64(30), 'D')
	readNext()
	assertVal(float64(45.58e-12), 'D')
	readNext()
